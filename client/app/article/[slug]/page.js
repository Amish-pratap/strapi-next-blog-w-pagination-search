...
import qs from "qs";
import { capitalizeFirstLetter, formatDate, makeCategory } from "@/app/utils";
...
const Article = async ({ params }) => {
  ...
  const article = await getArticle(queryString);
      ...
      <div className="col-span-2">
        ...
        <div className="flex items-center my-4">
          <div className="rounded-lg overflow-hidden flex items-center justify-center mr-2">
            <Image
              src={`http://127.0.0.1:1337${article.data[0].attributes.author.data.attributes.avatar.data.attributes.formats.thumbnail.url}`}
              height={40}
              width={40}
              alt=""
            />
        ...
        <div className="text-lg text-gray-600 leading-8">
          <img
            ...
            src={`http://127.0.0.1:1337${article.data[0].attributes.image.data.attributes.url}`}
            alt={article.data[0].attributes.title}
          />
          {article.data[0].attributes.body}
        </div>
      </div>
